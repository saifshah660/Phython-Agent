...
input_guardrails_agent = Agent(
    ...
    instructions="Check if the user's questions related to python programming, if it is, return true, if it is not , return false ",
    model=model,
...
main_agent = Agent(
    ...
    instructions="You are a Python Expert agent, you respond only to python related questions.",
    model=model,
...
async def on_message(message: cl.Message):
     try:
         ...
         await cl.Message(content="Please try python related questions").send()
